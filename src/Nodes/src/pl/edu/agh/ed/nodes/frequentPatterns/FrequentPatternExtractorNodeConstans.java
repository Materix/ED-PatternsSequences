...
public class FrequentPatternExtractorNodeConstans {
    ...
    static {
    	...
    	ALGORITHM.put("PrePost+", (Class<? extends IFrequentPatternsExtractor<IItem>>) PrePostPlusFrequentPatternsExtractor.class);
    	ALGORITHM.put("PrePost", (Class<? extends IFrequentPatternsExtractor<IItem>>) PrePostFrequentPatternsExtractor.class);
    	ALGORITHM.put("FIN", (Class<? extends IFrequentPatternsExtractor<IItem>>) FINFrequentPatternsExtractor.class);
    	ALGORITHM.put("H-Mine", (Class<? extends IFrequentPatternsExtractor<IItem>>) HMineFrequentPatternsExtractor.class);
    	ALGORITHM.put("LCMFreq", (Class<? extends IFrequentPatternsExtractor<IItem>>) LCMFreqFrequentPatternsExtractor.class);
    	ALGORITHM.put("Relim", (Class<? extends IFrequentPatternsExtractor<IItem>>) RelimFrequentPatternsExtractor.class);
    }
