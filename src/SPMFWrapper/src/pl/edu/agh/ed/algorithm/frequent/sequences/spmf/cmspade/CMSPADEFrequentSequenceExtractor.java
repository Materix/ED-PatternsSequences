package pl.edu.agh.ed.algorithm.frequent.sequences.spmf.cmspade;
...
public class CMSPADEFrequentSequenceExtractor implements IFrequentSequencesExtractor {
	...
	public IFrequentSequenceSet extract(ISequenceSet sequenceSet, double minRelativeSupport) {
		...
		try {
			...
			AlgoCMSPADE algo = new AlgoCMSPADE(minRelativeSupport, true, abstractionCreator);
			algo.runAlgorithm(sequenceDatabase, candidateGenerator, true, false, tempOutputFile.toString(), false);
