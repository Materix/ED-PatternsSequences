package pl.edu.agh.ed.algorithm.frequent.sequences.closed.spmf.bidePlus;
...
public class BidePlusClosedFrequentSequenceExtractor implements IClosedFrequentSequencesExtractor {
	...
	public IFrequentSequenceSet extract(ISequenceSet sequenceSet, double minRelativeSupport) {
		...
		try {
			...
			algo.runAlgorithm(tempInputFile.toString(), minRelativeSupport, tempOutputFile.toString());
