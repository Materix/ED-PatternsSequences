 ...
 * @author
 */
public class FilesBenchmarkClosedFrequentPatternExtractorNodeModel extends NodeModel {

	@SuppressWarnings("unused")
	private static final NodeLogger logger = NodeLogger
			.getLogger(FilesBenchmarkClosedFrequentPatternExtractorNodeModel.class);
	...
	protected FilesBenchmarkClosedFrequentPatternExtractorNodeModel() {
		super(0, 2);
	}
	...
	protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec)
		...
		List<String> algorithms = Arrays.asList(
				FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.ALGORITHMS_SETTINGS.getStringArrayValue());
		ITransactionSetReader<IItem> reader;
		if (FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.READ_AS_ORDERED_SETTINGS.getBooleanValue()) {
		...
		URL newUrl = FileUtil
				.toURL(FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.FILES_PATH_SETTINGS.getStringValue());
		...
		try (DirectoryStream<Path> dirStream = Files.newDirectoryStream(path, "*.txt")) {
			for (Path filePath : dirStream) {
				...
				for (String algorithm : algorithms) {
					...
					IFrequentPatternsExtractor<IItem> extractor = FilesBenchmarkClosedFrequentPatternExtractorNodeConstans
							.createExtractor(algorithm);
					Function<ITransactionSet<IItem>, IFrequentPatternSet<IItem>> executor;
					if (FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS
							.getBooleanValue()) {
						executor = set -> extractor.extract(set,
								FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS
										.getDoubleValue());
					} else {
						executor = set -> extractor.extract(set,
								FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.SUPPORT_SETTINGS
										.getIntValue());
					}
	...
	protected void saveSettingsTo(final NodeSettingsWO settings) {
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.SUPPORT_SETTINGS.saveSettingsTo(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.saveSettingsTo(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS.saveSettingsTo(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.READ_AS_ORDERED_SETTINGS.saveSettingsTo(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.ALGORITHMS_SETTINGS.saveSettingsTo(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.FILES_PATH_SETTINGS.saveSettingsTo(settings);
	}
	...
	protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.SUPPORT_SETTINGS.loadSettingsFrom(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.loadSettingsFrom(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS.loadSettingsFrom(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.READ_AS_ORDERED_SETTINGS.loadSettingsFrom(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.ALGORITHMS_SETTINGS.loadSettingsFrom(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.FILES_PATH_SETTINGS.loadSettingsFrom(settings);
	}
	...
	protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.SUPPORT_SETTINGS.validateSettings(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.validateSettings(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS.validateSettings(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.READ_AS_ORDERED_SETTINGS.validateSettings(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.ALGORITHMS_SETTINGS.validateSettings(settings);
		FilesBenchmarkClosedFrequentPatternExtractorNodeConstans.FILES_PATH_SETTINGS.validateSettings(settings);
	}
