...
public class BenchmarkClosedFrequentPatternExtractorNodeConstans {
	...
	public static final Map<String, Class<? extends IClosedFrequentPatternsExtractor<IItem>>> ALGORITHMS;

	static {
		ChangeListener isRelativeListener = e -> {
			boolean isRelative = BenchmarkClosedFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS
					.getBooleanValue();
			BenchmarkClosedFrequentPatternExtractorNodeConstans.SUPPORT_SETTINGS.setEnabled(!isRelative);
			BenchmarkClosedFrequentPatternExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.setEnabled(isRelative);
		};

		BenchmarkClosedFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS.addChangeListener(isRelativeListener);
	...
	public static IClosedFrequentPatternsExtractor<IItem> createExtractor(String name) {
		try {
