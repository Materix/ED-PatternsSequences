 ...
 * @author
 */
public class BenchmarkFrequentSequencesExtractorNodeModel extends NodeModel {

	@SuppressWarnings("unused")
	private static final NodeLogger logger = NodeLogger.getLogger(BenchmarkFrequentSequencesExtractorNodeModel.class);
	...
	protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec)
		...
		List<String> algorithms = Arrays
				.asList(BenchmarkFrequentSequencesExtractorNodeConstans.ALGORITHMS_SETTINGS.getStringArrayValue());
		...
		for (String algorithm : algorithms) {
			...
			IFrequentSequencesExtractor extractor = BenchmarkFrequentSequencesExtractorNodeConstans
					.createExtractor(algorithm);
			Function<ISequenceSet, IFrequentSequenceSet> executor;
			if (BenchmarkFrequentSequencesExtractorNodeConstans.IS_RELATIVE_SETTINGS.getBooleanValue()) {
				executor = set -> extractor.extract(set,
						BenchmarkFrequentSequencesExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.getDoubleValue());
			} else {
				executor = set -> extractor.extract(set,
	...
	protected void saveSettingsTo(final NodeSettingsWO settings) {
		BenchmarkFrequentSequencesExtractorNodeConstans.SUPPORT_SETTINGS.saveSettingsTo(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.saveSettingsTo(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.IS_RELATIVE_SETTINGS.saveSettingsTo(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.READ_AS_ORDERED_SETTINGS.saveSettingsTo(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.ALGORITHMS_SETTINGS.saveSettingsTo(settings);
	}
	...
	protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
		BenchmarkFrequentSequencesExtractorNodeConstans.SUPPORT_SETTINGS.loadSettingsFrom(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.loadSettingsFrom(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.IS_RELATIVE_SETTINGS.loadSettingsFrom(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.READ_AS_ORDERED_SETTINGS.loadSettingsFrom(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.ALGORITHMS_SETTINGS.loadSettingsFrom(settings);
	}
	...
	protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		BenchmarkFrequentSequencesExtractorNodeConstans.SUPPORT_SETTINGS.validateSettings(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.validateSettings(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.IS_RELATIVE_SETTINGS.validateSettings(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.READ_AS_ORDERED_SETTINGS.validateSettings(settings);
		BenchmarkFrequentSequencesExtractorNodeConstans.ALGORITHMS_SETTINGS.validateSettings(settings);
	}
