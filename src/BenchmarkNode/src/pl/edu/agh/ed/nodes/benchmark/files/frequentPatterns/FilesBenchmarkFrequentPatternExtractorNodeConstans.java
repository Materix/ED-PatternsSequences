...
public class FilesBenchmarkFrequentPatternExtractorNodeConstans {
	...
	static {
		ChangeListener isRelativeListener = e -> {
			boolean isRelative = FilesBenchmarkFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS.getBooleanValue();
			FilesBenchmarkFrequentPatternExtractorNodeConstans.SUPPORT_SETTINGS.setEnabled(!isRelative);
			FilesBenchmarkFrequentPatternExtractorNodeConstans.RELATIVE_SUPPORT_SETTINGS.setEnabled(isRelative);
		};

		FilesBenchmarkFrequentPatternExtractorNodeConstans.IS_RELATIVE_SETTINGS.addChangeListener(isRelativeListener);
