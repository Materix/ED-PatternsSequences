...
public class FrequentSequenceBenchmark {
	...
	public static void main(String[] args) throws IOException {
		Map<String, IFrequentSequencesExtractor> extractors = new HashMap<>();

		extractors.put("CMSPAM", new CMSPAMFrequentSequenceExtractor());
		extractors.put("CMSPADE", new CMSPADEFrequentSequenceExtractor());
		extractors.put("SPADE", new SPADEFrequentSequenceExtractor());
		extractors.put("SPAM", new SPAMFrequentSequenceExtractor());
		...
		Path outputTimeDirPath = Paths.get("output", "sequence", name, "time");
		if (!Files.exists(outputTimeDirPath)) {
			Files.createDirectories(outputTimeDirPath);
		}
		Path outputResultSizeDirPath = Paths.get("output", "sequence", name, "size");
		if (!Files.exists(outputResultSizeDirPath)) {
			Files.createDirectories(outputResultSizeDirPath);
		}
		Path outputMemoryDirPath = Paths.get("output", "sequence", name, "memory");
